...
public class GenerateSettings extends AbstractGenerate {
	...
	public void generate(SettingsType settingsType) throws IOException {
		...
		JetTemplate template = engine.getTemplate("settings" + separator + settingsType.getTpl());
	...
	public enum SettingsType {
		APPLICATION_CONTEXT("applicationContext.xml", "applicationContext.xml.ftl"), JDBC("jdbc.properties", "jdbc.properties.ftl"), LOGBACK("logback.xml", "logback.xml.ftl"), SPRING_MVC(
				"spring-mvc.xml", "spring-mvc.xml.ftl");
